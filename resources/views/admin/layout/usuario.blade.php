            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                   <!--<h6 class="collapse-header">Custom Utilities:</h6>--> 
                    <a class="collapse-item" href="{{route('admin.editarusuario')}}"><i class="fas fa-user-tie"></i> Cambiar Datos</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('admin.registrousuario')}}"><i class="fas fa-users"></i> Usuario</a>
                    <a class="collapse-item" href="{{route('admin.gerencia')}}"><i class="fas fa-user-tie"></i> Gerencias</a>
                </div>
            </div>
        </li>
